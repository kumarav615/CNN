...
x_npz = np.load("C:\\datafiles\\x_images_arrays.npz")
x = x_npz['arr_0']

# Load binary encoded labels for Lung Infiltrations: 0=Not_infiltration 1=Infiltration
y_npz = np.load("C:\\datafiles\\y_infiltration_labels.npz")
y = y_npz['arr_0']
...
with open("/Users/satyak/PycharmProjects/ML_pipenv/7_gpu/model.json", "w") as json_file:
    json_file.write(model_json)

# serialize weights to HDF5 and save
model.save_weights("/Users/satyak/PycharmProjects/ML_pipenv/7_gpu/model.h5")
